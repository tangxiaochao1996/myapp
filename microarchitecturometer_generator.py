...
def help_and_quit():
    ...
    print("microarchitecturometer_generator.py --list work", file=sys.stderr)
    print("microarchitecturometer_generator.py --list padding", file=sys.stderr)
    raise SystemExit
...
if work_arg == '--list':
    try:
        arg_options = {"work": work_opts, "padding": padding_opts}[padding_arg]
    except KeyError:
        help_and_quit()
